...
import campaignPaymentTimerRoutes from "./campaignPaymentTimerRoutes.js";
...
router.use("/v1/campaign-payment", campaignPaymentTimerRoutes);
router.use("/v1/transactions", transactionRoutes);
router.use("/v1/admin/review", adminReviewRoutes);
router.use("/v1/umkm", umkmRoutes);
